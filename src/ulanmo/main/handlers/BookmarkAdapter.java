...
public class BookmarkAdapter extends ArrayAdapter<RainfallMeasurement>
	...
	public void updateMeasurements() {
		...
		if (getItem(0).getLastUpdate() != null
			...
			lastUpdateText.setText("Data as of "
					+ DateUtility.getHour(getItem(0).getLastUpdate())
					+ ". Click to refresh bookmarks");
		else
			lastUpdateText.setText("Click to refresh bookmarks");
	}
